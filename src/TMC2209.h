...
public:
  ...
  constexpr static uint8_t REPLY_DELAY_MAX = 15;
...
private:
  ...
  constexpr static uint32_t ECHO_DELAY_INC_MICROSECONDS = 1;
  constexpr static uint32_t ECHO_DELAY_MAX_MICROSECONDS = 4000;

  constexpr static uint32_t REPLY_DELAY_INC_MICROSECONDS = 1;
  constexpr static uint32_t REPLY_DELAY_MAX_MICROSECONDS = 10000;

  constexpr static uint8_t STEPPER_DRIVER_FEATURE_OFF = 0;
  constexpr static uint8_t STEPPER_DRIVER_FEATURE_ON = 1;

  constexpr static uint8_t MAX_READ_RETRIES = 5;
  constexpr static uint32_t READ_RETRY_DELAY_MS = 20;

  // Datagrams
  constexpr static uint8_t WRITE_READ_REPLY_DATAGRAM_SIZE = 8;
  constexpr static uint8_t DATA_SIZE = 4;
  ...
  constexpr static uint8_t SYNC = 0b101;
  constexpr static uint8_t RW_READ = 0;
  constexpr static uint8_t RW_WRITE = 1;
  constexpr static uint8_t READ_REPLY_SERIAL_ADDRESS = 0b11111111;
  ...
  constexpr static uint8_t VERSION = 0x21;
  ...
  constexpr static uint8_t CURRENT_SETTING_MIN = 0;
  constexpr static uint8_t CURRENT_SETTING_MAX = 31;
  ...
  constexpr static uint8_t SEIMIN_UPPER_CURRENT_LIMIT = 20;
  ...
  constexpr static uint8_t VSENSE_DISABLE = 0;
  constexpr static uint8_t VSENSE_ENABLE = 1;
